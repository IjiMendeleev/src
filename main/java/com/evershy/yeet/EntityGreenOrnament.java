...
import net.minecraftforge.fml.relauncher.SideOnly;
	...
	public class EntityGreenOrnament extends EntityThrowable
	{
		...
		public EntityGreenOrnament(World worldIn, String name)
	    {
		...
		public EntityGreenOrnament(World worldIn)
	    {
	    ...
	    public EntityGreenOrnament(World worldIn, EntityLivingBase throwerIn)
	    {
	        super(worldIn, throwerIn);
	        this.OrnamentInventory = new InventoryBasic("Item", false, 1);
	    }

	    public EntityGreenOrnament(World worldIn, double x, double y, double z)
	    {
		...
		protected void onImpact(RayTraceResult result) 
		{
			        ...
			        {   			        	
			        	...
			        	this.dropItem(AItems.GREORNAMENT, 1);
