...
import net.minecraftforge.fml.relauncher.SideOnly;
	...
	public class EntityWhiteOrnament extends EntityThrowable
	{
		...
		public EntityWhiteOrnament(World worldIn, String name)
	    {
		...
		public EntityWhiteOrnament(World worldIn)
	    {
	    ...
	    public EntityWhiteOrnament(World worldIn, EntityLivingBase throwerIn)
	    {
	        super(worldIn, throwerIn);
	        this.OrnamentInventory = new InventoryBasic("Item", false, 1);
	    }

	    public EntityWhiteOrnament(World worldIn, double x, double y, double z)
	    {
		...
		protected void onImpact(RayTraceResult result) 
		{
			        ...
			        {   			        	
			        	...
			        	this.dropItem(AItems.WHTORNAMENT, 1);
