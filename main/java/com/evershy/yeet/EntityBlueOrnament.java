...
import net.minecraftforge.fml.relauncher.SideOnly;
	...
	public class EntityBlueOrnament extends EntityThrowable
	{
		...
		public EntityBlueOrnament(World worldIn, String name)
	    {
		...
		public EntityBlueOrnament(World worldIn)
	    {
	    ...
	    public EntityBlueOrnament(World worldIn, EntityLivingBase throwerIn)
	    {
	        super(worldIn, throwerIn);
	        this.OrnamentInventory = new InventoryBasic("Item", false, 1);
	    }

	    public EntityBlueOrnament(World worldIn, double x, double y, double z)
	    {
		...
		protected void onImpact(RayTraceResult result) 
		{
			        ...
			        {   			        	
			        	...
			        	this.dropItem(AItems.BLUORNAMENT, 1);
