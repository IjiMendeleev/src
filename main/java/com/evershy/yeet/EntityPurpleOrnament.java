...
import net.minecraftforge.fml.relauncher.SideOnly;
	...
	public class EntityPurpleOrnament extends EntityThrowable
	{
		...
		public EntityPurpleOrnament(World worldIn, String name)
	    {
		...
		public EntityPurpleOrnament(World worldIn)
	    {
	    ...
	    public EntityPurpleOrnament(World worldIn, EntityLivingBase throwerIn)
	    {
	        super(worldIn, throwerIn);
	        this.OrnamentInventory = new InventoryBasic("Item", false, 1);
	    }

	    public EntityPurpleOrnament(World worldIn, double x, double y, double z)
	    {
		...
		protected void onImpact(RayTraceResult result) 
		{
			        ...
			        {   			        	
			        	...
			        	this.dropItem(AItems.PURORNAMENT, 1);
