...
import net.minecraftforge.fml.relauncher.SideOnly;
	...
	public class EntityEnderOrnament extends EntityThrowable
	{
		...
		public EntityEnderOrnament(World worldIn, String name)
	    {
		...
		public EntityEnderOrnament(World worldIn)
	    {
	    ...
	    public EntityEnderOrnament(World worldIn, EntityLivingBase throwerIn)
	    {
	        super(worldIn, throwerIn);
	        this.OrnamentInventory = new InventoryBasic("Item", false, 1);
	    }

	    public EntityEnderOrnament(World worldIn, double x, double y, double z)
	    {
		...
		protected void onImpact(RayTraceResult result) 
		{
			 ...
			 int j = this.rand.nextInt(256);
			        ...
			        {   
			           if (j <= 4)
			           {  
			        	EntityEnderman creeper = new EntityEnderman(this.world);
			           ...
			           if (j > 4)
			           {
			        	this.dropItem(AItems.ENDORNAMENT, 1);
