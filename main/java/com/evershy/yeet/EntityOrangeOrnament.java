...
import net.minecraftforge.fml.relauncher.SideOnly;
	...
	public class EntityOrangeOrnament extends EntityThrowable
	{
		...
		public EntityOrangeOrnament(World worldIn, String name)
	    {
		...
		public EntityOrangeOrnament(World worldIn)
	    {
	    ...
	    public EntityOrangeOrnament(World worldIn, EntityLivingBase throwerIn)
	    {
	        super(worldIn, throwerIn);
	        this.OrnamentInventory = new InventoryBasic("Item", false, 1);
	    }

	    public EntityOrangeOrnament(World worldIn, double x, double y, double z)
	    {
		...
		protected void onImpact(RayTraceResult result) 
		{
			        ...
			        {   			        	
			        	...
			        	this.dropItem(AItems.ORGORNAMENT, 1);
