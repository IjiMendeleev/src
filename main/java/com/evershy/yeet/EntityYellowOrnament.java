...
import net.minecraftforge.fml.relauncher.SideOnly;
	...
	public class EntityYellowOrnament extends EntityThrowable
	{
		...
		public EntityYellowOrnament(World worldIn, String name)
	    {
		...
		public EntityYellowOrnament(World worldIn)
	    {
	    ...
	    public EntityYellowOrnament(World worldIn, EntityLivingBase throwerIn)
	    {
	        super(worldIn, throwerIn);
	        this.OrnamentInventory = new InventoryBasic("Item", false, 1);
	    }

	    public EntityYellowOrnament(World worldIn, double x, double y, double z)
	    {
		...
		protected void onImpact(RayTraceResult result) 
		{
			        ...
			        {   			        	
			        	...
			        	this.dropItem(AItems.YELORNAMENT, 1);
