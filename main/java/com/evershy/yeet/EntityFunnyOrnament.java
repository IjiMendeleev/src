...
import net.minecraftforge.fml.relauncher.SideOnly;
	...
	public class EntityFunnyOrnament extends EntityThrowable
	{
		...
		public EntityFunnyOrnament(World worldIn, String name)
	    {
		...
		public EntityFunnyOrnament(World worldIn)
	    {
	    ...
	    public EntityFunnyOrnament(World worldIn, EntityLivingBase throwerIn)
	    {
	        super(worldIn, throwerIn);
	        this.OrnamentInventory = new InventoryBasic("Item", false, 1);
	    }

	    public EntityFunnyOrnament(World worldIn, double x, double y, double z)
	    {
		...
		protected void onImpact(RayTraceResult result) 
		{
			        ...
			        {   			        	
			        	...
			        	this.dropItem(AItems.FUNORNAMENT, 1);
